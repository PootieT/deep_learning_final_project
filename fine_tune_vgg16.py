...
parser.add_argument('--train_dir', default='/media/peter/Elements/recognition_of_human_action_data/data/TRAIN')
parser.add_argument('--val_dir', default='/media/peter/Elements/recognition_of_human_action_data/data/VALIDATION')
parser.add_argument('--model_path', default='/media/peter/Elements/recognition_of_human_action_data/model/vgg_16.ckpt', type=str)
...
def list_images(directory):
    ...
    for file in files:
    	...
    	for frame in os.listdir(os.path.join(directory, file)):
    		cnt += 1
    		files_and_labels.append((os.path.join(directory, file, frame), label))
